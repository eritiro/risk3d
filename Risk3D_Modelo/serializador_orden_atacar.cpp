...
void SerializadorOrdenAtacar::serializar(Escritor& escritor, Orden& orden){
	OrdenAtacar orden_especifica = dynamic_cast<OrdenAtacar&>(orden);
...
Orden* SerializadorOrdenAtacar::deserializar(Lector& lector, InfoJuego& info){
	...
	return FabricaDeOrdenes::crear_orden_atacar(origen, destino, ejercitos);
}
